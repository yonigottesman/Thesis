...
%
\documentclass[MSc]{misc/iitthesis}
...
% With your TeX distribution you might need to create files in thenn
% UTF-8 charset.
...
\include{main/motivation}
\include{main/intro}

%background
\include{main/virtualization}
\include{main/iostack}
\include{main/pciebus}
%NeSC 
\include{main/design}
\include{main/architecture}
%results
